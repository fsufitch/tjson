...
class TestTJ(TestCase):
    ...
    def test_path(self):
        ...
        assert (
            self.node["cats"][0]["extraProperties"]["foo bar"].path
            == ".cats[0].extraProperties['foo bar']"
        )
    ...
    def test_bool_null(self):
        # Meowsalot has a null value for this,
        # which should come back as None when the type is unspecified
    ...
    def test_number(self):
        ...
        # Int and float are distinct, but they both get served by .number
    ...
    def test_number_null(self):
        # Meowsalot has a null value for this, which should be None on type unspecified
    ...
    def test_array_iteration(self):
        assert [
            (it.path, it.value) for it in self.node["cats"][0]["favoriteSayings"]
        ] == [
    ...
    def test_object_iteration(self):
        assert [
            (it.path, it.value) for it in self.node["cats"][0]["extraProperties"]
        ] == [
